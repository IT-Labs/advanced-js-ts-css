...
const CssPosition = () => {
  ...
  const notes: Array<Content> = [
    ...
    {key: 2, question: 'absolute', answer: 'The element is positioned relative to its first positioned (not static) ancestor element.'},
    {key: 3, question: 'fixed', answer: '	The element is positioned relative to the browser window.'},
    {key: 4, question: 'relative', answer: 'The element is positioned relative to its normal position.'},
