...
const TypeScriptIntro = () => {
  ...
  const notes: Array<Content> = [
    {key: 0, question: 'What is TypeScript?', answer: 'It is a superset of Javascript. Created and maintained by Microsoft. Any valid JavaScript code is valid TypeScript code.'},
    {key: 1, question: 'What is Different?', notes: [
      {key: 0, content: 'Strong typing'}, {key: 1, content: 'Compile-time errors'}, {key: 2, content: 'Intellisense'}
    ]},
